class Hooks(object):
    # post_app_init(worker): Called just after a worker has initialized the application.
    ...
    def __init__(
        self, post_app_init=None, post_worker_fork=None, post_worker_exit=None
    ):
        super().__init__()
        self.post_app_init = (
            post_app_init if post_app_init else self.__default_post_app_init
        )
    ...
    def __default_post_app_init(self, worker):
        pass
